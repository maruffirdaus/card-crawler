        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              Divider(),
              CreditItem(
                assetName: 'Background Music 2 - The Ice Caves',
                assetSource: 'OpenGameArt.org',
                assetCreator: 'BonoboGames',
                licenseType: LicenseType.ccBy30,
              ),
              Divider(),
              CreditItem(
                assetName: 'War: Humans March',
                assetSource: 'OpenGameArt.org',
                assetCreator: 'Bobjt',
                licenseType: LicenseType.ccBy30,
              ),
              Divider(),
              CreditItem(
                assetName: 'Disturbing Developments',
                assetSource: 'OpenGameArt.org',
                assetCreator: 'Mega Pixel Music Lab',
                licenseType: LicenseType.ccBySa40,
              ),
              Divider(),
              CreditItem(
                assetName: 'RPG_Lost_In_Time',
                assetSource: 'OpenGameArt.org',
                assetCreator: 'Hitctrl',
                licenseType: LicenseType.ccBy30,
              ),
              Divider(),
              CreditItem(
