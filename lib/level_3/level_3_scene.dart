      ...
      frames: {
        ...
        '1': ConversationFrame(
          conversations: {
            ...
            '5.1': ConversationUnit(
              character: Character.lukas,
              texts: [
                'Hold on to that. It\'s what will keep you fighting.',
              ],
              choices: [
            ...
            '5.2.3': ConversationUnit(
              character: Character.lukas,
              texts: [
                'You will. We’ll get through this, together.'
              ],
              choices: [
                ConversationChoice(text: 'Next', nextUnitId: '6'),
              ],
        ...
        '3': ConversationFrame(
          conversations: {
            ...
            '4': ConversationUnit(
              ...
              choices: [
                ConversationChoice(text: '"Push Lukas away"', nextUnitId: '5.1'),
                ConversationChoice(text: '"Hit the monster"', nextUnitId: '5.2'),
              ],
            ),
            '5.1': ConversationUnit(
              character: Character.cole,
              texts: ['ARGHHHH!!'],
              choices: [
                ConversationChoice(text: 'Next', nextUnitId: '5.1.1'),
              ],
            ),
            '5.1.1': ConversationUnit(
              texts: ['You managed to save Lukas, but you got hit instead. (-3 Health)'],
              choices: [
                ConversationChoice(text: 'Next', nextUnitId: '5.1.2'),
              ],
            ),
            ...
            '5.2': ConversationUnit(
              texts: ['The monster almost got a hit on Lukas, you saved him on time'],
              choices: [
                ConversationChoice(text: 'Next', nextUnitId: '5.2.1'),
              ],
            ),
            '5.2.1': ConversationUnit(
              character: Character.cole,
            ...
            '6': ConversationUnit(
              character: Character.lukas,
              texts: ['I\'m fine, i didn\'t expect it to jump on me.','Anyway, I think we have more company.'],
              choices: [
                ConversationChoice(text: 'Next', nextFrameId: '4'),
              ],
            ),
          },
          gameStage: GameStage.castle,
        ...
        '5': ConversationFrame(
          conversations: {
            ...
            '1': ConversationUnit(
              character: Character.lukas,
              texts: ['The door opened! Hurry, get inside *cole*.','I\'ll hold them off!'],
              choices: [
                ConversationChoice(text: 'Next', nextUnitId: '2'),
              ],
            ),
            ...
            '4': ConversationUnit(
              texts: ['Lukas ran as fast as he could toward you.','As soon as he passed, you quickly slammed the door shut.'],
              choices: [
            ...
            '5': ConversationUnit(
              character: Character.lukas,
              texts: ['Remind me why we thought storming a monster-infested castle was a good idea?'],
              choices: [
                ConversationChoice(text: 'Next', nextUnitId: '6'),
              ],
            ),
            ...
            '8': ConversationUnit(
              ...
              choices: [
                ConversationChoice(text: 'Next', nextFrameId: '6'),
              ],
            ),
          },
          gameStage: GameStage.castle,
        ),
        '6': CoreGameFrame( //boss stage
            gameCards: AccessoryGameCard.entries,
            gameStage: GameStage.castle,
            nextId: '7'
        ...
        '7': ConversationFrame(
          conversations: {
            ...
            '5': ConversationUnit(
              ...
              choices: [
                ConversationChoice(text: 'Stand your ground, fight for your wish.', nextUnitId: '6.1'),
                ConversationChoice(text: 'Step back, give up your wish.', nextUnitId: '6.2')
              ],
            ),
            '6.1': ConversationUnit(
              ...
              choices: [
                ConversationChoice(text: 'Next', nextUnitId: '6.1.1'),
              ],
            ),
            '6.1.1': ConversationUnit(
              ...
              choices: [
                ConversationChoice(text: 'Next', nextUnitId: '6.1.2'),
              ],
            ),
            '6.1.2': ConversationUnit(
              ...
              choices: [
                ConversationChoice(text: 'Next', nextUnitId: '6.1.3'),
              ],
            ),
            '6.1.3': ConversationUnit(
              ...
              choices: [
                ConversationChoice(text: 'Next', nextFrameId: '8'),
              ],
            ),
            '6.2': ConversationUnit(
              character: Character.cole,
              texts: ['Alright, Lukas. I understand. I won\'t interfere with your wish.'],
              choices: [
                ConversationChoice(text: 'Next', nextFrameId: '11'),
              ],
            ),
          },
          gameStage: GameStage.castle,
        ),
        '8': CoreGameFrame( // lawan lukas
          gameCards: AccessoryGameCard.entries,
          gameStage: GameStage.castle,
          nextId: victory ? '9' : '10' //game will auto save here?, 9 if win, 10 if lose var victory ada di paling atas, belum implement datengnya dari mana
        ),
        '9': ConversationFrame( //if win
          conversations: {
            '0': ConversationUnit(
              texts: ['Lukas collapses, clutching his wounds, eyes filled with disbelief.'],
              choices: [
                ConversationChoice(text: 'Next', nextUnitId: '1'),
              ],
            ),
        ...
        '10': ConversationFrame( //if lose
          conversations: {
            ...
            '2': ConversationUnit(
              character: Character.lukas,
              texts: [
                'I want you to cure my wife\'s illness. That\'s it.',
              ],
              choices: [
                ConversationChoice(text: 'Next', nextUnitId: '3'),
              ],
            ...
            '4': ConversationUnit(
              character: Character.cole,
              texts: [
                'Lukas… the castle… it\'s collapsing…',
              ],
              choices: [
                ConversationChoice(text: 'Next', nextUnitId: '5'),
              ],
        ...
        '11': ConversationFrame( //if gave up wish
          conversations: {
            '0': ConversationUnit(
              texts: [
            ...
            '5': ConversationUnit(
              character: Character.lukas,
              texts: [
                'I wish for my wife to be cured of her illness!',
              ],
              choices: [
                ConversationChoice(text: 'Next', nextUnitId: '6'),
              ],
            ...
            '8': ConversationUnit(
              ...
              choices: [
                ConversationChoice(text: 'Next', nextUnitId: '9'),
              ],
            ),
            '9': ConversationUnit(
              texts: [
              ...
              choices: [
                ConversationChoice(text: 'Next', nextUnitId: '10'),
              ],
            ),
            '10': ConversationUnit(
              character: Character.cole,
              ...
              choices: [
                ConversationChoice(text: 'Next', nextUnitId: '11'),
              ],
            ),
            '11': ConversationUnit( //ending 3
              texts: [
