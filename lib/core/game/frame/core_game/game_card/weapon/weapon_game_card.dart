import 'package:card_crawler/core/game/frame/core_game/game_card/weapon/weapon_game_card_effect.dart';
...
class WeaponGameCard extends GameCard {
  ...
  @override
  GameCard copy() =>
      WeaponGameCard._(id: id, value: value, effect: effect, sprite: sprite);
